...
class EmployeeService:
    ...
    def update_employee(
        self, employee_id: int, data: EmployeeUpdate, db: Session
        ...
        for field, value in update_data.items():
            if field == "email" and value is not None:
                value = str(value)
            if field in ("employee_code", "employee_name") and isinstance(value, str):
                value = value.strip()
